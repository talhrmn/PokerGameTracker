...
import {
	HANDS_COLUMNS,
	PLAYER_COLUMNS,
} from "@/app/dashboard/games/components/game-details/consts";
import { useGameTableQuery } from "@/app/dashboard/games/components/game-details/game-details-queries";
import styles from "@/app/dashboard/games/components/game-details/styles.module.css";
import {
	GameDetailsProps,
	NotableHandsDetailProps,
} from "@/app/dashboard/games/components/game-details/types";
import {
	Calendar,
	Clock,
	DollarSign,
