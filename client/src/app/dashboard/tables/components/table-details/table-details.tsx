...
import {
	...
	useTableDelete,
	useTableSubmit,
} from "@/app/dashboard/tables/components/table-details/table-details-queries";
import { TableDetailsModalProps } from "@/app/dashboard/tables/components/table-details/types";
import QRCodeInviteModal from "@/app/dashboard/tables/components/table-invite/table-invite";
import {
	CircleOff,
	CirclePlus,
	CircleX,
