...
import { statusOrder } from "@/app/dashboard/tables/components/table-invite/consts";
import styles from "@/app/dashboard/tables/components/table-invite/styles.module.css";
import {
	useFetchFriendsQuery,
	useSendInvite,
} from "@/app/dashboard/tables/components/table-invite/table-invite-queries";
import { InviteModalProps } from "@/app/dashboard/tables/components/table-invite/types";
import { PlayerStatus } from "@/app/dashboard/tables/types";
import {
	Check,
	CircleX,
	Search,
...
const InviteModal: React.FC<InviteModalProps> = ({
	...
	const formatFriendsList = (friendsList?: FriendsResponse) => {
		if (!friendsList) return [];
		return friendsList?.friends.map((user: FriendsProps) => ({
			user_id: user._id,
	...
	const friends = formatFriendsList(friendsList);
