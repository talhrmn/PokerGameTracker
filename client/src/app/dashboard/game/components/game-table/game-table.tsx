import styles from "@/app/dashboard/game/components/game-table/styles.module.css";
import { PokerTableProps } from "@/app/dashboard/game/components/game-table/types";
import { CHIP_VALUES } from "@/app/dashboard/game/components/player-chip/consts";
import Chip from "@/app/dashboard/game/components/player-chip/player-chip";
import PlayerSeat from "@/app/dashboard/game/components/player-seat/player-seat";
import { Position } from "@/app/dashboard/game/components/player-seat/types";
