...
import {
	useAddPlayerBuyIn,
	usePlayerCashOut,
} from "@/app/dashboard/game/components/player-details/player-details-queries";
import styles from "@/app/dashboard/game/components/player-details/styles.module.css";
import { PlayerDetailsProps } from "@/app/dashboard/game/components/player-details/types";
import { BuyInsProps } from "@/app/dashboard/games/types";
