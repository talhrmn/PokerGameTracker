import { PlayerSeatProps } from "@/app/dashboard/game/components/player-seat/types";
import styles from "@/app/dashboard/game/components/player-seat/styles.module.css";
