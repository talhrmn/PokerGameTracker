import {
	BLIND_OPTIONS,
	POKER_GAME_OPTIONS,
} from "@/app/dashboard/components/poker-table-form/consts";
import { PokerTableFormProps } from "@/app/dashboard/components/poker-table-form/types";
import styles from "@/app/dashboard/components/poker-table-form/styles.module.css";
