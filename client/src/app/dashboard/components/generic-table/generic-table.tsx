...
import {
	CellValueType,
	GenericTableProps,
} from "@/app/dashboard/components/generic-table/types";
import styles from "@/app/dashboard/components/generic-table/styles.module.css";
import {
	ArrowRight,
	ChevronLeft,
	ChevronRight,
			...
			<div className={styles.content}>
				...
				<div className={styles.tableWrapper}>
					<div className={styles.tableContainer}>
						{data.length ? tableData : emptyTable}
					</div>
